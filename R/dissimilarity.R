...
#' @param method Method to use. Support D1, D2 and Lee. \eqn{D1 = sqrt(L_x)(1-r_xy)}. \eqn{D2 = sqrt(L_x)sqrt(L_y)(1-r_xy)}. Lee for Lee's L score. In default use D1 method, see the manual for details.
