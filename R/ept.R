...
annoEPT <- function(gr = NULL, dat = NULL) {
...
expr.prop <- function(ept.counts = NULL, gene.counts = NULL, ept.gene = NULL, pesudo = 1, cells = NULL, genes = NULL, epts = NULL)
{
